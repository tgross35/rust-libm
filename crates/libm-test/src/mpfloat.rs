...
macro_rules! impl_mp_op {
    ...
    (
        ...
        paste::paste! {
            impl MpOp for crate::func::$fn_name::Func {
                type MpTy = MpFloat;
...
macro_rules! impl_op_for_ty {
    ($fty:ty, $suffix:literal) => {
        paste::paste! {
            impl MpOp for crate::func::[<copysign $suffix>]::Func {
                type MpTy = (MpFloat, MpFloat);
            ...
            impl MpOp for crate::func::[<pow $suffix>]::Func {
                type MpTy = (MpFloat, MpFloat);
            ...
            impl MpOp for crate::func::[<fmod $suffix>]::Func {
                type MpTy = (MpFloat, MpFloat);
            ...
            impl MpOp for crate::func::[<jn $suffix>]::Func {
            ...
            impl MpOp for crate::func::[<sincos $suffix>]::Func {
                type MpTy = (MpFloat, MpFloat);
